...
const ChapterList = () => {
    ...
    const applyFilters = () => {
        const filtered = users.filter(user =>
            user.lesson_title.toLowerCase().includes(searchTerm.toLowerCase())
        );
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Êtes-vous sûr de vouloir supprimer cet cour ?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                        ...
                        <TableBody>
                            {filteredUsers.slice((page - 1) * rowsPerPage, page * rowsPerPage).map((row, i) => (
                                <TableRow key={row.id}>
                                    ...
                                    <TableCell>{row.lesson_description}</TableCell>
