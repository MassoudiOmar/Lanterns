...
const CohortList = () => {
    ...
    let checkpermissions = () => {
        ...
        let userPermissions = token.filter(permission => permission.includes("path"));
    ...
    const handleDeleteConfirmation = () => {
        ...
        console.log(token)
        axios.delete(configData.API_SERVER + `paths/${userToDeleteId}`, {
            headers: {
    ...
    const applyFilters = () => {
        const filtered = users.filter(user =>
            user.path_name.toLowerCase().includes(searchTerm.toLowerCase())
        );
        ...
        <MainCard title="Paths" >
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Êtes-vous sûr de vouloir supprimer cet path ?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
            ...
            {users?.length ?
                    ...
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                {(usersPermission.includes('path_delete') || usersPermission.includes('path_update')) &&
                                    ...
                                    <TableCell>
                                        {
                                            <>
                                                ...
                                                {usersPermission.includes('path_delete') &&
                ...
                [0, 1, 2, 3, 4].map((e, i) => (
                    ...
                    <Grid key={i} item xs={12} margin={2}>
